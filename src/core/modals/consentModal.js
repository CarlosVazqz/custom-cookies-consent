...
export const createConsentModal = (api, createMainContainer) => {
   ...
   */
    ...
    const acceptAllBtnData = consentModalData.acceptAllBtn,
        ...
        showAdditionalInfoBtnData = consentModalData.showAdditionalInfoBtn,
   ...
   */
    ...
    if (showAdditionalInfoBtnData) {
        if (!dom._cmShowAdditionalInfoBtn) {
            dom._cmShowAdditionalInfoBtn = createNode(BUTTON_TAG);
            appendChild(dom._cmShowAdditionalInfoBtn, createFocusSpan());
            addClassCm(dom._cmShowAdditionalInfoBtn, 'btn');
            addClassCm(dom._cmShowAdditionalInfoBtn, 'btn--secondary');
